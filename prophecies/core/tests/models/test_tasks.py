...
class TestTask(TestCase):
    def setUp(self):
        ...
        self.art = Task.objects.create(name='Art', project=self.project, color='#fe6565')
        self.shop = Task.objects.create(name='Shop', project=self.project)
    ...
    def test_progress_by_on_two_tasks(self):
