...
class TestTaskRecord(TestCase):
    ...
    def test_it_should_ignore_task_link_template(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={original_value}')
        task_record = TaskRecord.objects.create(task=task, link='https://offshoreleaks.icij.org', original_value='foo')
        self.assertEqual(task_record.computed_link(), 'https://offshoreleaks.icij.org')
    ...
    def test_it_should_use_task_link_template_with_metadata(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata.foo}')
    ...
    def test_it_should_use_task_link_template_with_nested_metadata(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata.foo.bar}')
    ...
    def test_it_should_use_task_link_template_with_nested_list(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata.foo.bar[1]}')
    ...
    def test_it_should_use_task_link_template_with_canonical_string(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata}')
    ...
    def test_it_should_use_task_link_template_with_a_list(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata[1]}')
    ...
    def test_it_should_use_task_link_template_with_a_list_of_objects(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata[1].city}')
    ...
    def test_it_should_use_task_link_template_with_urlencored_original_value(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={original_value:u}')
    ...
    def test_it_should_use_task_link_template_with_urlencored_metadata_field(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={metadata.city:u}')
    ...
    def test_it_should_use_task_link_template_with_unknown_key(self):
        task = Task.objects.create(name='Addresses', project=self.project, record_link_template='https://www.openstreetmap.org/search?query={foo}')
