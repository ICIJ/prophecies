    ...
    <div class="tip-list__container flex-grow-1">
      ...
      <div class="container-fluid px-4">
        <app-waiter :loader="fetchTipsLoader" waiter-class="my-5 mx-auto d-block">
          ...
          <div v-else v-for="(tasksObject, projectName) in tipsGroupedByProjectThenTask" :key="projectName"
            ...
            <div v-for="(taskTips, taskIdVal) in tasksObject" :key="taskIdVal" class="mb-4">
              ...
              <b-list-group-item v-for="tip in taskTips" class="flex-column align-items-start ml-4 border-0"
                                 :key="tip.id">
