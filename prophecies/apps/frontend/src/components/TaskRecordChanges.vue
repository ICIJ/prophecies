...
<template>
  <div class="task-record-review-changes">
    ...
    <div class="task-record-review-changes__actions">
      <div class="task-record-review-changes__actions__item task-record-review-changes__actions__item--empty"
           v-if="!actions.length">
      ...
      <div v-for="action in actions" :key="action.id" class="task-record-review-changes__actions__item d-flex">
        ...
        <div class="task-record-review-changes__actions__item__timestamp text-secondary text-nowrap"
             :title="action.timestamp | formatDateLong" v-b-tooltip.hover>
