...
<template>
  <div class="user-profile-dropdown-menu">
    ...
    <b-dropdown-item :to="activityRoute"
    ...
    <b-dropdown-item :to="notificationsRoute"
    ...
    <b-dropdown-item :to="bookmarksRoute"
    ...
    <b-dropdown-item :to="historyRoute"
    ...
    <b-dropdown-item :href="$config.get('apiUrl')"
    ...
    <template v-if="user.isStaff">
      <b-dropdown-item :href="$config.get('adminUrl')"
    ...
    <b-dropdown-item :href="$config.get('helpLink')"
    ...
    <b-dropdown-item :href="$config.get('logoutUrl')"
