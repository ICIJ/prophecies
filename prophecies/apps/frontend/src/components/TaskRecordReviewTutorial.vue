      ...
      <div class="row mb-3">
        ...
        <div class="col-auto task-record-review-tutorial-card__buttons">
          ...
          >
            <arrow-left-icon
              size="0.8x"
              class="mr-3 align-baseline text-right task-record-review-tutorial-card__buttons__arrow"
            />
            {{ $t('tutorial.previous') }}
          </b-btn>
          <b-btn
          ...
          >
            <span class="task-record-review-tutorial__right-button-width">{{ $t('tutorial.next') }} </span>
          ...
          <b-btn
            ...
            @click="closeTutorial()"
          >
            <span class="task-record-review-tutorial__right-button-width">{{ $t('tutorial.close') }} </span>
