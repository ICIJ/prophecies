...
<template>
  <li class="history-list-item row py-3 m-0">
    ...
    <div class="row container-fluid justify-content-between flex-grow-1">
      <div class="d-flex flex-grow-lg-0 flex-grow-1 px-3 py-1 history-list-item__content-column col-12 col-lg-5"
           :class="className">
        <p>
      ...
      <div
        ...
        <div class="ml-3  py-1 text-sm-left text-md-right  history-list-item__date-column">{{timestamp | formatDate}}
        </div>
      </div>
    </div>
  </li>
