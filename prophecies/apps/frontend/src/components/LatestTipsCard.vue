<template>
  <div class="latest-tips-card card card-body py-4 px-5 shadow">
    <div class="d-flex">
      <div v-if="showClose" class="mt-2 order-2">
    ...
    <ul v-if="hasLatestTips" class="list-unstyled latest-tips-card__tips">
      <li v-for="tip in latestTips" :key="tip.id" class="latest-tips-card__tips__item">
        <div class="row">
          <div class="col">
