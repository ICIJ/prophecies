...
<template>
  <div v-if="user" class="user-card" :class="{ 'user-card--with-background': background }">
    <app-waiter :loader="fetchLoader">
      ...
      <div v-else class="d-flex">
        ...
        <div class="flex-grow-1">
          ...
          <div v-if="assignedTaskIds.length" class="user-card__assigned-tasks">
          ...
          <slot name="footer" :assigned-task-ids="assignedTaskIds"></slot>
        </div>
      </div>
    </app-waiter>
  </div>
