...
<template>
  <div class="user-notifications-dropdown-menu">
    <user-notifications class="user-notifications-dropdown-menu__list dropdown" :notification-ids="notificationIds">
      <template #header>
        <div class="b-dropdown-text d-flex align-items-center">
          <h3 class="my-2">Notifications</h3>
          <b-btn
      ...
      <template #link="{ notification }">
        <user-notification-link :key="notification.id" class="dropdown-item py-3" :notification-id="notification.id" />
      </template>
    </user-notifications>
